...
public class ComputeAreaAndPerim { 
    ...
    public static void main(String args[]) {
        AbstractShape myShape; // declare an object in our class. 
        double perimeter;
        double area;
        myShape = getShape(); // Ask for figure type-it will return an object as a shape, for all different shapes
     ...
     */
    public static AbstractShape getShape() { // method 
