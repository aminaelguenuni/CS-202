...
public class CircApp
   ...
   public static void main(String[] args) throws IOException
      ...
      putText("Enter the the number of spaces to skip: ");// number of passes 
      nSkips = getInt();
      ...
      //theList.find(3);
      // Add your code here
      //step1: find the starting player 
      theList.find(startNo);
      //step 2: start passing the hot potato nSkips
      while (theList.getSize()>1) {
      //Step3: pass potato nskips times for eacj round 
...
// -------------------------------------------------------------
   public int getSize()
      { return count; }
// -------------------------------------------------------------
   public void insert(int id)     // insert after current link+ will be added after the current one 
      {                           // make new link
      Link newLink = new Link(id); // it is the new node or the newLink
